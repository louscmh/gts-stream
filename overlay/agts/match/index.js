...
(async () => {
    try {
        const jsonData = await $.getJSON("../../../_data/beatmaps_agts.json");
...
class Beatmap {
    ...
    generateOverview() {
        ...
        this.mapSource.setAttribute('src', "../../../_shared_assets/design/agts/main_banner.png");
        this.mapPickIcon.setAttribute('src', "../../../_shared_assets/design/agts/pick_arrow_overview.png");
        this.mapBanPlayer.setAttribute('src', "../../../_shared_assets/design/agts/main_banner.png");
    ...
    generateQueue(isPlayerOne, isBan = false) {
        ...
        this.mapPickQueue.setAttribute("src", `../../../_shared_assets/design/agts/pick_queue_${isPlayerOne ? "left" : "right"}.png`);
    ...
    updateMatchSong(data) {
        if (beatmapsIds.includes(data.menu.bm.id)) {
            ...
            this.matchSource.onerror = function () {
                this.matchSource.setAttribute('src', `../../../_shared_assets/design/agts/main_banner.png`);
            };
        } else {
...
class GameplayManager {
    ...
    reset() {
        ...
        this.matchOneScore.style.color = "#0fa625";
        this.matchTwoScore.style.color = "#0fa625";
    ...
    revealScore(leftWon) {
        if (leftWon) {
            ...
            this.matchWinningLeftContent.style.backgroundColor = "#0fa625";
            ...
            this.matchWinningRightContent.style.width = "100%";
            this.matchWinningRightContent.style.backgroundColor = "#0fa625";
...
class HistoryManager {
    constructor(leftPlayer, rightPlayer) {
        ...
        this.leftHistory = [];
        this.rightHistory = [];
        this.rounds = ["Week 1", "Week 2", "Week 3", "Quarterfinals", "Semifinals", "Finals", "Grand Finals"];
