...
(async () => {
    try {
        ...
        const jsonData_2 = await $.getJSON("../../../_data/seeding_rgts.json");
...
class Beatmap {
    ...
    generateOverview() {
        ...
        this.mapPickIcon.setAttribute('src', "../../../_shared_assets/design/rgts/pick_arrow_overview.png");
        this.mapBanPlayer.setAttribute('src', "../../../_shared_assets/design/rgts/main_banner.png");
    ...
    generateQueue(isPlayerOne, isBan = false) {
        ...
        this.mapPickQueue.setAttribute("src", `../../../_shared_assets/design/rgts/pick_queue_${isPlayerOne ? "left" : "right"}.png`);
    ...
    updateMatchSong(data) {
        if (beatmapsIds.includes(data.menu.bm.id)) {
            ...
            this.matchSource.onerror = function () {
                this.matchSource.setAttribute('src', `../../../_shared_assets/design/rgts/main_banner.png`);
            };
        } else {
